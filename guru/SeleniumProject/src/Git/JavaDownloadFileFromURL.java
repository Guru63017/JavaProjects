	...
	private static void downloadUsingNIO(String urlStr, String file) throws IOException {
		...
		public class MainClass 
		{
			public static void main(String[] args) throws IOException {
				String strData = â€œjavascript:playMp3(â€˜https://www.englishspeak.com/instantspeak/English/phrases/mp3/aFew.mp3â€™)â€�;
					String strFind = â€œhttps://www.englishspeak.com/instantspeak/English/phrases/mp3/â€�;

						File file = new File(â€œD:\\htmlformp3.txtâ€�);
